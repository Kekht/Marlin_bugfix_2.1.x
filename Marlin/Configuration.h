...
#define STRING_CONFIG_H_AUTHOR "Kekht, Ender2 Pro" // Who made the changes.
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_CENTER  // ((X_BED_SIZE - 10) / 2) // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT Y_CENTER  // ((Y_BED_SIZE - 10) / 2) // (mm) Y point for Z homing
